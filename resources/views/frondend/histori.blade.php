<x-frond-layout title="Histori-belanja">
    <div class="container">
        <!-- HERO SECTION-->
        ...
        <section class="py-5">
            <h2 class="h5 text-uppercase mb-4">Histori Belanja</h2>
            <div class="row">
                        ...
                        <table class="table text-nowrap">
                            <thead class="bg-light">
                                ...
                                <tr>
                                    ...
                                    <th class="border-0 p-3" scope="col"> <strong
                                            class="text-sm text-uppercase">Kurir</strong></th>
                                    <th class="border-0 p-3" scope="col"> <strong
                            ...
                            <tbody class="border-0">
                                ...
                                @foreach ($orders as $order)
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-3 align-middle border-light">
                                            <p class="mb-0 small">{{ $order->kurir }}</p>
                                        </td>
                                        <td class="p-3 align-middle border-light">
